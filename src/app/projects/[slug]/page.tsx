            ...
            <div className="space-y-4">
              ...
              {project.repoUrl && (
                <a
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium bg-[#1E293B] text-[#94A3B8] rounded-md border border-[#334155] hover:text-[#00D9FF] hover:border-[#00D9FF]/50 transition-colors"
                >
                  <svg
                    className="h-4 w-4"
                    fill="currentColor"
